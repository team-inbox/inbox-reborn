...
let select = {
    ...
    bundleWrappers:      ()=>document.querySelectorAll('.BltHke[role=main] .bundle-wrapper, .aE3[role=main] .bundle-wrapper'),
    inbox:               ()=>document.querySelector('.nZ[data-tooltip=Inbox]'),
    importanceMarkers:   ()=>document.querySelector('td.WA.xY'),
    emails:              ()=>document.querySelectorAll('.BltHke[role=main] .zA, .aE3[role=main] .zA'),
